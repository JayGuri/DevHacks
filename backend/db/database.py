# backend/db/database.py — MongoDB Atlas connection and initialization
"""
...
async def connect_to_mongo():
    ...
    try:
        ...
        from db.models import User, Project, ProjectMember, JoinRequest, Notification, ActivityLog
