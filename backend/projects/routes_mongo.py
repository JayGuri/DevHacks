# backend/projects/routes_mongo.py — MongoDB Projects REST API
"""
MongoDB version of project CRUD operations using Beanie ODM.
"""
...
from db.mongo_models import User, Project, ProjectMember, _uuid, _invite_code
