...
const FeaturePill = ({ icon: Icon, label }) => (
  <div className="flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-4 py-2">
    ...
    <span className="metric-label text-[10px] text-white/80 tracking-widest leading-none">{label}</span>
  </div>
);
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center bg-slate-950 border-r border-white/5">
        ...
        {!reducedMotion && (
          ...
          >
            ...
            <div className="w-full h-full relative flex items-center justify-center scale-[1.5] translate-y-[-5%] translate-x-[40%]">
              <Suspense
                fallback={
